...
<head>
<meta charset="UTF-8">
<title>Jennie Main</title>
<link rel="stylesheet" type="text/css" href="/whistle/resources/css/w3.css">
<link rel="stylesheet" type="text/css" href="/whistle/resources/css/base.css">
<script type="text/javascript" src="/whistle/resources/js/jquery-3.6.0.min.js"></script>
<script type="text/javascript" src="/whistle/resources/js/jennie/main.js"></script>
<style>
	h5, span {
		height: 20px;
		line-height: 30%;
...
<body>
	...
	<div class="w3-content w3-center mw700">
		<h1 class="w3-teal w3-padding" style="margin-bottom: 5px;">Jennie Project</h1>
		<div class="w3-col">
<c:if test="${empty SID}">
