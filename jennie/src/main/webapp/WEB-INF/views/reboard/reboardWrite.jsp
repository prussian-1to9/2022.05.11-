...
<body>
	<div class="w3-content mxw750 w3-margin-top">
		...
		<header class="w3-col w3-card-4 mgb20">
			<h1 class="w3-pink w3-center w3-padding mg0">Pink 게시글 작성</h1>
...
<c:if test="${not empty SID}">
			...
			<div class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
				...
				<div class="w3-rest w3-padding">
					<div class="w3-col w3-border-bottom">
						<span class="w3-third w3-left mgb10 ft10"><b>글 내용</b></span>
					</div>
		...
		<div class="w3-col w3-margin-top">
			...
			<div class="w3-third w3-button w3-blue" id="wpbtn">Apply</div>
		</div>
