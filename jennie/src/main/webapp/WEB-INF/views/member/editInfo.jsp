...
<script type="text/javascript" src="/whistle/resources/js/jennie/edit.js"></script>
<style type="text/css">
	.avtimg {
		width: 100px;
		height: 100px;
...
<body>
	<div class="w3-content w3-margin-top mxw700">
		<!-- 타이틀 -->
		<h1 class="w3-pink w3-center w3-padding w3-card-4">Whistle 회원 정보 수정</h1>
		<form method="POST" action="" name="frm" id="frm"
			...
			<div>
				...
				<h4 class="w3-col s8 mgl10 mgb10">${DATA.id}</h4>
			</div>
			<div>
				...
				<div class="w3-col s8 mgl10 mgb10">
					...
					<span class="w3-col w3-text-red w3-center" id="pwmsg"></span>
				</div>
			</div>
			<div>
			...
			<div>
				...
				<h4 class="w3-col s8 mgl10 mgb10">${DATA.gen eq "F" ? "여자" : "남자"}</h4>
			</div>
